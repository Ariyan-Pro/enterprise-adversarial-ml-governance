...
print("\n[TOOL] Initializing core components...")
...
try:
    ...
    print("  [OK] Model Firewall: Initialized")
except Exception as e:
    print(f"  [WARNING]  Model Firewall: {str(e)[:60]}...")
    firewall = None
...
try:
    ...
    print("  [OK] Adversarial Intelligence: Initialized")
except Exception as e:
    print(f"  [WARNING]  Adversarial Intelligence: {str(e)[:60]}...")
    intelligence = None
...
try:
    ...
    try:
            ...
            model.eval()
            print(f"  [OK] MNIST CNN: Loaded from {model_path.name}")
            print(f"     Parameters: {sum(p.numel() for p in model.parameters()):,}")
    except Exception as e:
            print(f"  [WARNING]  MNIST CNN: Using untrained model (loading error: {str(e)[:40]}...)")
    else:
        print("  [WARNING]  MNIST CNN: Weights not found, using untrained model")
        
except Exception as e:
    print(f"  [ERROR] MNIST CNN: Failed to initialize - {str(e)[:60]}...")
    model = None
...
try:
    ...
    print("[AUTONOMOUS] Autonomous evolution engine available")
...
print(f"[OK] Autonomous controller initialized")
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("[ROCKET] STARTING ENTERPRISE ADVERSARIAL ML SECURITY PLATFORM")
    print("="*80)
    ...
    print("\n[TARGET] Ready to serve ML predictions with enterprise security!")
